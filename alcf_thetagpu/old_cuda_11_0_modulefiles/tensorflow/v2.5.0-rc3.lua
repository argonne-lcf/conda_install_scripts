...
Includes build of Tensorflow from a tagged version of the git repo
Tensorflow version tag: 2.5.0-rc3
...
local conda_dir = "/lus/theta-fs0/software/thetagpu/conda/tf_2/v2.5.0-rc3/mconda3"
