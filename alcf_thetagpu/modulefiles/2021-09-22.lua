...
DeepHyper version tag: 92554f9
TensorFlow version tag: 2.6.0
Horovod version tag: 0.22.1
PyTorch version tag: 1.9.1
- PyTorch DDP with NCCL (2.9.9+cuda11.0) may or may not work with this module
Magma and Mamba both installed
...
local conda_dir = "/lus/theta-fs0/software/thetagpu/conda/2021-09-22/mconda3"
...
prepend_path("PATH","/lus/theta-fs0/software/thetagpu/cuda/nccl_2.9.9-1+cuda11.0_x86_64/include")
