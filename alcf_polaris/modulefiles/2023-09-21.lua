...
TensorFlow version tag: 2.13.0
Horovod version tag: 0.28.1
PyTorch version tag: 2.0.1
...
local conda_dir = "/soft/datascience/conda/2023-09-21/mconda3"
...
prepend_path("PATH","/soft/libraries/nccl/nccl_2.18.3-1+cuda11.8_x86_64/include")
prepend_path("LD_LIBRARY_PATH","/soft/libraries/nccl/nccl_2.18.3-1+cuda11.8_x86_64/lib")
prepend_path("LD_LIBRARY_PATH","/soft/libraries/trt/TensorRT-8.5.3.1.Linux.x86_64-gnu.cuda-11.8.cudnn8.6/lib")


local cuda_home = "/soft/compilers/cudatoolkit/cuda-11.8.0"
setenv("CUDA_HOME",cuda_home)
setenv("CUDA_TOOLKT_BASE",cuda_home)
